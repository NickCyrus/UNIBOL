...
; (function ($, window, document, undefined) {
    ...
    $.extend(bstreeView.prototype, {
        ...
        init: function () {
            ...
            $(this.element).on('dblclick', '.list-group-item', function (e) {
                    fn.addNewCC({ code : $(this).attr("data-bs-code")});
            })
        ...
        build: function (parentElement, nodes, depth) {
            ...
            $.each(nodes, function addNodes(id, node) {
                ...
                var treeItem = $(templates.treeviewItem)
                    ...
                    .attr('data-bs-code', node.code)

                    .css({'padding-left': leftPadding, color : node.color })
