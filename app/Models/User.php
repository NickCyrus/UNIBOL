...
class User extends Authenticatable
{
    ...
    public function getNameRol(){
         ...
         return  profileModel::find($this->profid)->profname;
    ...
    public function getPermissionAttribute() {
      return  $this->hasMany(profpermission::class, 'profid', 'profid')->select('modappid')->get()->toArray();
    }    

    public function getMenuLeft(){
       
        return modulesapp::whereIn('id', $this->permission)->orderby('orderapp')
            ->NotParent()
            ->StatusActive([1])
            ->get();
    }
