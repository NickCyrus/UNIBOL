...
class modulesController extends Controller
{
        ...
        function index(){
                ...
                return view('modules.index' , ['modulos'=> modulesapp::orderBy('id_parent','ASC')->orderby('orderapp')->get() , 
        ...
        static public function getOptionMaster(){
            return modulesapp::NotParent()->StatusActive()->orderBy('orderapp')->get();
        }
