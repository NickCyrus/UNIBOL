...
class salariesController extends Controller
{
    ...
    private $slugRoute  = 'salariosadmon';
    private $type  = 1;
    private $title = 'Salarios Admon';
    private $firstLabel = '';
    ...
    function index(){
            ...
            return view( $this->slug.'.index' , ['slug'=>'salariosadmon', 'type'=>$this->type , 'title'=>$this->title ,'modulos'=> $rs , 'permission'=>Auth::User()->permission($this->idApp)]);
    ...
    function add(){
        ...
        return response()->json(['html'=> view($this->slug.'.form' , ['module'=>new salarys , 'type'=>$this->type , 'slug'=>'salariosadmon' , 'title'=>$this->title])->render()]);
    ...
    function edit($id){
        ...
        return response()->json(['html'=> view($this->slug.'.form' , ['module'=>salarys::find($id) , 'type'=>$this->type , 'slug'=>'salariosadmon' , 'title'=>$this->title])->render()]);
