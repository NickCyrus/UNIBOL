      ...
      <table class="table table-striped dn-table dt-responsive">
        ...
        <tbody class="table-border-bottom-0">
          ...
          <tr>
            ...
            @if ($type != 1)
            <td>{{$modulo->getCategory()}}</td>
            @endif 
            <td>@currency($modulo->value)</td>
            <td>@currency($modulo->value_day)</td>
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  @if ($permission->adelete)
                    <a class="dropdown-item hand confirm" data-q='¿Desea eliminar este registro?' href="{{route("{$slug}.delete",['id'=>$modulo->id])}}"><i class="bx bx-trash me-1"></i> Delete</a>
                  @endif
                </div>
              </div>
            </td>
