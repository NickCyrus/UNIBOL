<?php
    ...
    $data['model'] = 'App\Models\ie\IeAprobationDocument';
    $data['title'] = 'Tipo de documentos de aprobación';
    ...
    $data['validate'] = [
                            'name'=> ['required', 'unique:ie_aprobation_documents,name,{id},id'],
                            'abbreviation'=> ['required', 'unique:ie_aprobation_documents,abbreviation,{id},id']
                        ];
    $data['validateMSG'] = [
