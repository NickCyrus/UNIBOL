          ...
          <tr>
            ...
            <td>
                @if ($cotizacion->state !=3)
                    <a class="btn btn-sm btn-danger" href="{{route('contratos.cotizaciones.item.delete', ['id'=>$contrato->id, 'item'=>$cotizacionid , 'iditem'=> $modulo->id] )}}" ><i class="bx bx-trash me-1"></i></a>
                @endif
            </td>
          </tr>
          @empty
