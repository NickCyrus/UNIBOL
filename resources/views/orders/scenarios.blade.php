            ...
            <div id="accordion">
                <div class="card-body">
                    ...
                    <div class="escenario-gramaje mb-5">
                        <h3 class="text-secondary mb-4 d-flex justify-content-center align-items-center">
                            <button class="btn btn-primary" type="button" onclick="toggleCollapse('collapse{{ $gramaje }}')">
                                Gramaje: {{ $gramaje }} GSM
                            </button>
                        </h3>

                        <div id="collapse{{ $gramaje }}" class="collapse-content" style="display: none;">
