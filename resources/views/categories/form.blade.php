<div class="container py-3">
    <form action="{{route('categorias.save')}}" method="POST">
        @csrf
        <input name="id" value="{{$module->id}}" type="hidden" />
        <div class="row mb-3">
          <label class="col-sm-3 col-form-label" for="basic-default-name">Nombre de categoría</label>
          <div class="col-sm-9">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-9">
            <input type="text" name="orden" value="{{$module->orden}}" class="form-control on" placeholder="" required>
          </div>
        </div>
